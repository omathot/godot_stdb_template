...
pub mod config_type;
pub mod db_vec_2_type;
pub mod entity_table;
pub mod entity_type;
pub mod insert_mock_player_reducer;
...
pub use db_vec_2_type::DbVec2;
pub use entity_table::*;
pub use entity_type::Entity;
pub use insert_mock_player_reducer::{
    insert_mock_player, set_flags_for_insert_mock_player, InsertMockPlayerCallbackId,
};
...
pub use set_player_name_reducer::{
    set_flags_for_set_player_name, set_player_name, SetPlayerNameCallbackId,
};
...
impl __sdk::Reducer for Reducer {
    fn reducer_name(&self) -> &'static str {
        match self {
            Reducer::InsertMockPlayer { .. } => "insert_mock_player",
...
impl TryFrom<__ws::ReducerCallInfo<__ws::BsatnFormat>> for Reducer {
    ...
    fn try_from(value: __ws::ReducerCallInfo<__ws::BsatnFormat>) -> __sdk::Result<Self> {
        match &value.reducer_name[..] {
            "insert_mock_player" => Ok(__sdk::parse_reducer_args::<
                insert_mock_player_reducer::InsertMockPlayerArgs,
            >("insert_mock_player", &value.args)?
            .into()),
